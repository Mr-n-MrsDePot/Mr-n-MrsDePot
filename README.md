...
| **Universal Robots Operator Guide** | Cobot setup, calibration, and how-tos |
| **Epilog Laser Operator Guide** | Laser engraver / cutter operator program |
| **Haas CNC Operator Guide** | Haas mill / lathe operator program |
| **Procolored R1390 Error Guide** | Error-code lookup with diagrams and fix steps |

### AI voice agents & calling

| Build | What it is |
|-------|------------|
| **[Ryan](https://github.com/Mr-n-MrsDePot/ryan)** | Consumer AI calling assistant (Flutter · VAPI · Firebase) — architecture showcase |
| **[Taylor](https://github.com/Mr-n-MrsDePot/taylor)** | B2B PropTech AI calling for property managers — architecture showcase |
| **Rex** | All-day voice PC agent — listens, speaks, and operates the desktop |
| **Voice AI Lab** | Voice-training lab: audio hygiene → STT → Orpheus LoRA |
| **AutoCall** | App Store outbound calling product |
| **BizCall** | Business calling product |
...
| **Serenova** | Mental-wellness app — mood, journal, companion chat |
| **DieSmart AI Assistant** | On-site chat assistant trained on diesmart.com content |
...
| **SQL Studio** | Plain-English → production SQL via Grok |
| **Code Lens** | Code-reading web app |
| **Media Echo** | Find photos and videos you didn't know existed |
| **Instagram Auto-Poster** | Daily scheduled posting from a local folder |

---

**Stack:** Flutter · Dart · Python · TypeScript · React · Vite · Next.js · FastAPI · VAPI · Firebase · CrewAI · xAI / Grok · iOS

**Portfolio:** [mr-n-mrsdepot.github.io/portfolio](https://mr-n-mrsdepot.github.io/portfolio/)  
